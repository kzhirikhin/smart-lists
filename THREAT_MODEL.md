...
`sha256:bdc45b2…85cb6469` заблокирован: 49 High-находок по 12 CVE в пакетах
Debian, ноль VEX и waiver. Это открытый operational alert, а не результат
pre-deploy gate; для каждой находки требуются исправление или отдельное
доказательство применимости и решение по runbook.
...
Распределение на 2026-09-18 с A98–A99: **T — 38, M — 34, — — 13, R — 7, T\* — 7**
(99 строк).
