...
| A93 | После миграции Vertex AI остаётся единственным доступным AI-каналом приложения | Сохранённая Anthropic federation позволяла бы тратить вне Vertex Spend Cap | ✅ владелец сообщил об архивировании правила `fdrl_01TMxGCrboyf8U4HeN94msmS` 2026-09-18; Anthropic API/Console независимо агентом не прочитаны. Новая production-ревизия работает без четырёх `ANTHROPIC_*` и прошла smoke; ревизий с Anthropic-кодом не осталось вовсе — 32 удалены 2026-09-18, живут `00059-fhh` и `00058-kdq`, обе на Vertex AI. Десятиминутное окно ранее выданных токенов истекло в тот же день. **Остаток, который эта строка не закрывает:** иные правила federation, API-ключи и service accounts организации Anthropic не инвентаризированы — доступ к Console у владельца, агент его не брал, поэтому «единственный канал» проверено со стороны GCP и со стороны кода, но не со стороны Anthropic | M | 2026-09-18 |
