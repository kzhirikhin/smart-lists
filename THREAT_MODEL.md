...
красят, а Critical и исправимые High блокируют по-прежнему. Replay этого
отчёта даёт PASS; подтверждение живым run выполняется после merge FastAPI PR.
